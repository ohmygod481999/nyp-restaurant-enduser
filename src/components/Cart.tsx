  ...
  return (
    <div className="cart osahan-checkout">
      <div className="bg-primary border-bottom px-3 pt-3 pb-5 d-flex align-items-center">
        ...
        <h4 className="font-weight-bold m-0 text-white ">Order</h4>
        <button
      ...
      <div className="p-3 osahan-cart-item">
        <div className="d-flex mb-3 osahan-cart-item-profile bg-white shadow rounded p-3 mt-n5">
          <img
            alt="osahan"
            src="https://media-cdn.tripadvisor.com/media/photo-s/1b/67/cc/f8/chestnut-restaurant.jpg"
            className="store-image mr-3 rounded-circle"
          />
          <div className="d-flex flex-column">
            ...
            <p className="mb-0 small text-muted">
              <i className="feather-map-pin" /> 2036 2ND AVE, NEW YORK, NY 10029
            </p>
          </div>
        </div>
        {/**/}
        ...
        <div className="mb-3 shadow bg-white rounded p-3 py-3 mt-3 clearfix">
          <div className="input-group-sm mb-2 input-group">
            ...
            <div className="input-group-append">
              <button id="button-addon2" type="button" className=" btn-primary">
