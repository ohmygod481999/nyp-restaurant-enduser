  ...
  const { company_id, branch_id, table_id } = useParams()
    ...
    <div className="row">
      <div className="col selected">
        <Link to={`/${company_id}/${branch_id}/${table_id}/home`} className="text-danger small font-weight-bold text-decoration-none">
          <p className="h4 m-0"><i className="feather-home text-danger" /></p>
          Trang chủ
        </Link>
      </div>
      {/* <div className="col">
        <Link to={`/${company_id}/${branch_id}/${table_id}/trending`} className="text-dark small font-weight-bold text-decoration-none">
