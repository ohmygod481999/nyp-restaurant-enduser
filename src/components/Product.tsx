    ...
    >
        ...
        <div className="noteModal_overlay">
          <div className="noteModal">
            <div className="noteModal_header">
              ...
              <button onClick={() => setNoteModal(false)}>Close</button>
            </div>
            ...
            <button onClick={submitOrder} className="noteModal_order_btn">
              Hoàn tất
            </button>
          </div>
        </div>
      ...
      <div className="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm grid-card">
        <div className="list-card-image">
          ...
          >
            <AiOutlineShoppingCart onClick={handleAdd} style={iconStyle} />
          </button>
